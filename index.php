...
<main role="main">
	...
	<!--HEADER COM MENUS, BUSCA E REDES EM ARQUIVO SEPARADO-->
	<header id="topo">
...
<div id="corpo_home">
	...
	<!--INICIO SECTION COM AS DIVS DE ARTIGOS, ETC-->
	<section id="artigos_container">
		...
		<p><a href='artigos_index.php'><i class='fas fa-plus-square'></i> TODOS OS ARTIGOS</a></p>
